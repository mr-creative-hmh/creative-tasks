...
<template>
  ...
  <EmployeeMobileLayout>
    ...
    <div class="bg-gradient-to-br from-sky-700 via-sky-800 to-slate-900 rounded-3xl p-5 text-white shadow-xl shadow-sky-900/20 mb-5 relative overflow-hidden">
      ...
      <div class="flex items-center justify-between gap-3 relative z-10">
        ...
        <div class="shrink-0 flex flex-col items-center justify-center w-16 h-16 rounded-2xl bg-white/15 backdrop-blur-md border border-white/20">
          <span class="text-lg font-black text-white font-mono">{{ summary.avg_progress }}%</span>
          <span class="text-[9px] font-bold text-sky-100">{{ t('avgProgress') || 'المعدل' }}</span>
        </div>
      </div>
